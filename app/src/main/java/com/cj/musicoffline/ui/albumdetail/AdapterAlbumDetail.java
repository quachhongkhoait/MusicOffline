...
import com.cj.musicoffline.ui.playlist.AdapterListDetail;
import com.cj.musicoffline.utils.HandlingMusic;
import com.makeramen.roundedimageview.RoundedImageView;

import java.util.List;

public class AdapterAlbumDetail extends RecyclerView.Adapter<AdapterAlbumDetail.ViewHolder> {
    ...
    public AdapterAlbumDetail(List<AudioModel> mLvAudioModel, Context context, AdapterAlbumDetail.OnClickItemDetailListener onClickItemDetailListener) {
    ...
    @NonNull
    @Override
    public AdapterAlbumDetail.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.viewholder_music, parent, false);
        AdapterAlbumDetail.ViewHolder viewHolder = new AdapterAlbumDetail.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterAlbumDetail.ViewHolder holder, int position) {
